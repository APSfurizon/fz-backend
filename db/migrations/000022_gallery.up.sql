...
create type upload_progress_info_type as ENUM('PRESIGNED', 'PRESIGNED_MULTIPART');
...
(
    ...
    size                    int8                                                                                                                     NOT NULL,
    upload_type             upload_progress_info_type                                                                                                NOT NULL,
    ...
    CONSTRAINT upload_progress_info_type_check CHECK (((s3_upload_id IS NULL) AND (upload_type = 'PRESIGNED')) OR ((s3_upload_id IS NOT NULL) AND (upload_type = 'PRESIGNED_MULTIPART'))),
...
(
    id                        int8 GENERATED BY DEFAULT AS IDENTITY ( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    original_uploader_user_id int8                                                                                                                     NULL,
    photographer_user_id      int8                                                                                                                     NULL,
