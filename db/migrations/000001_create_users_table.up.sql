...
CREATE TABLE IF NOT EXISTS users (
    ...
    user_country varchar(8) DEFAULT 'en'::character varying NULL,
...
CREATE TABLE IF NOT EXISTS billing_info (
    billing_info_id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    billing_info_is_default bool NOT NULL,
    billing_info_first_name varchar(255) NULL,
    billing_info_last_name varchar(255) NULL,
    billing_info_address varchar(255) NULL,
    billing_info_zip varchar(16) NULL,
    billing_info_city varchar(64) NULL,
    billing_info_country varchar(64) NULL,
    user_id int8 NOT NULL,
    CONSTRAINT billing_info_id_pkey PRIMARY KEY (billing_info_id),
    CONSTRAINT billing_info_id_user_fk FOREIGN KEY (user_id) REFERENCES users(user_id)
);
...
CREATE TABLE IF NOT EXISTS user_group (
    group_id int8 NULL,
    user_id int8 NULL,
    CONSTRAINT user_group_pkey PRIMARY KEY (user_group_id, user_id),
