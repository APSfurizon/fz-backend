...
(
    ...
    user_secret       varchar(70)                                                                                                              NOT NULL, -- todo remove --
...
CREATE SEQUENCE IF NOT EXISTS membership_cards_id_in_years INCREMENT BY 1 MINVALUE 1 START 1;
...
(
    ...
    id_in_year int4 DEFAULT nextval('membership_cards_id_in_years')                                                                     NOT NULL,
