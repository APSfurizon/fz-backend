...
(
    ...
    CONSTRAINT role_unique_internal_name UNIQUE (internal_name)
);
...
(
    ...
    CONSTRAINT permission_role_fk FOREIGN KEY (role_id) REFERENCES role (role_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    CONSTRAINT user_has_role_role_fk FOREIGN KEY (role_id) REFERENCES role (role_id) ON DELETE CASCADE ON UPDATE CASCADE
);
