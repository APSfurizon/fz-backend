...
public class RestPretixRefundFinder implements PretixRefundFinder {
    private final ParameterizedTypeReference<PretixPaging<PretixRefund>> pretixPagedPayment =
    ...
    @NotNull
    @Override
    public PretixPaging<PretixRefund> getPagedRefunds(
            @NotNull String organizer,
            @NotNull String event,
            @NotNull String orderCode,
            int page
    ) {
        final var request = HttpRequest.<PretixPaging<PretixRefund>>create()
    ...
    @Override
    public List<PretixRefund> getRefundsForOrder(
            @NotNull Event event,
            @NotNull String orderCode
    ) {
