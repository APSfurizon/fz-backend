...
public interface OrderFinder {
    ...
    @Nullable
    Order findOrderByCheckinSecretEvent(@NotNull String secret, @NotNull Event event, @NotNull PretixInformation pretixService);
    ...
    @Nullable Board getBoardOfUser(long userId, long eventId);
}
