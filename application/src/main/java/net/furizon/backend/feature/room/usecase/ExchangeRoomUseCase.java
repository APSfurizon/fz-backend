...
import static net.furizon.backend.infrastructure.rooms.RoomEmailTexts.BODY_ROOM_HAS_NEW_OWNER;
import static net.furizon.backend.infrastructure.rooms.RoomEmailTexts.TITLE_ROOM_UPDATED;
