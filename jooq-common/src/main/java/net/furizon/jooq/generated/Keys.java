...
public class Keys {
    ...
    public static final UniqueKey<Record> UPLOAD_EXIF_ONLY_ONE_PER_UPLOAD = Internal.createUniqueKey(UploadExif.UPLOAD_EXIF, DSL.name("upload_exif_only_one_per_upload"), new TableField[] { UploadExif.UPLOAD_EXIF.UPLOAD_ID }, true);
    ...
    public static final ForeignKey<Record, Record> AUTHENTICATIONS__AUTHENTICATIONS_USERS_FK = Internal.createForeignKey(Authentications.AUTHENTICATIONS, DSL.name("authentications_users_fk"), new TableField[] { Authentications.AUTHENTICATIONS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> EMAIL_CONFIRMATION_REQUEST__MAIL_CONFIRM_AUTH_FK = Internal.createForeignKey(EmailConfirmationRequest.EMAIL_CONFIRMATION_REQUEST, DSL.name("mail_confirm_auth_fk"), new TableField[] { EmailConfirmationRequest.EMAIL_CONFIRMATION_REQUEST.AUTHENTICATION_ID }, Keys.AUTHENTICATIONS_PKEY, new TableField[] { Authentications.AUTHENTICATIONS.AUTHENTICATION_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> EXCHANGE_CONFIRMATION_STATUS__EXCHANGE_CONFIRMATION_STATUS_EVENT_FK = Internal.createForeignKey(ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS, DSL.name("exchange_confirmation_status_event_fk"), new TableField[] { ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS.EVENT_ID }, Keys.EVENT_PKEY, new TableField[] { Events.EVENTS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> EXCHANGE_CONFIRMATION_STATUS__EXCHANGE_CONFIRMATION_STATUS_SOURCE_USER_FK = Internal.createForeignKey(ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS, DSL.name("exchange_confirmation_status_source_user_fk"), new TableField[] { ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS.SOURCE_USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> EXCHANGE_CONFIRMATION_STATUS__EXCHANGE_CONFIRMATION_STATUS_TARGET_USER_FK = Internal.createForeignKey(ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS, DSL.name("exchange_confirmation_status_target_user_fk"), new TableField[] { ExchangeConfirmationStatus.EXCHANGE_CONFIRMATION_STATUS.TARGET_USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> FURSUITS__FURSUITS_MEDIA_FK = Internal.createForeignKey(Fursuits.FURSUITS, DSL.name("fursuits_media_fk"), new TableField[] { Fursuits.FURSUITS.MEDIA_ID_PROPIC }, Keys.MEDIA_PKEY, new TableField[] { Media.MEDIA.MEDIA_ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> FURSUITS__FURSUITS_USERS_FK = Internal.createForeignKey(Fursuits.FURSUITS, DSL.name("fursuits_users_fk"), new TableField[] { Fursuits.FURSUITS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> FURSUITS_ORDERS__FURSUITS_ORDERS_FURSUIT_FK = Internal.createForeignKey(FursuitsOrders.FURSUITS_ORDERS, DSL.name("fursuits_orders_fursuit_fk"), new TableField[] { FursuitsOrders.FURSUITS_ORDERS.FURSUIT_ID }, Keys.FURSUITS_PKEY, new TableField[] { Fursuits.FURSUITS.FURSUIT_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> FURSUITS_ORDERS__FURSUITS_ORDERS_ORDER_FK = Internal.createForeignKey(FursuitsOrders.FURSUITS_ORDERS, DSL.name("fursuits_orders_order_fk"), new TableField[] { FursuitsOrders.FURSUITS_ORDERS.ORDER_ID }, Keys.ORDERS_PKEY, new TableField[] { Orders.ORDERS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    public static final ForeignKey<Record, Record> MEMBERSHIP_CARDS__CARD_USER_FK = Internal.createForeignKey(MembershipCards.MEMBERSHIP_CARDS, DSL.name("card_user_fk"), new TableField[] { MembershipCards.MEMBERSHIP_CARDS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.CASCADE);
    ...
    public static final ForeignKey<Record, Record> RESET_PASSWORD_REQUESTS__RESET_PW_AUTH_FK = Internal.createForeignKey(ResetPasswordRequests.RESET_PASSWORD_REQUESTS, DSL.name("reset_pw_auth_fk"), new TableField[] { ResetPasswordRequests.RESET_PASSWORD_REQUESTS.AUTHENTICATION_ID }, Keys.AUTHENTICATIONS_PKEY, new TableField[] { Authentications.AUTHENTICATIONS.AUTHENTICATION_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.CASCADE);
    ...
    public static final ForeignKey<Record, Record> USERS__USER_MEDIA_FK = Internal.createForeignKey(Users.USERS, DSL.name("user_media_fk"), new TableField[] { Users.USERS.MEDIA_ID_PROPIC }, Keys.MEDIA_PKEY, new TableField[] { Media.MEDIA.MEDIA_ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.CASCADE);
    ...
    public static final ForeignKey<Record, Record> UPLOAD_EXIF__UPLOAD_EXIF_UPLOAD_ID = Internal.createForeignKey(UploadExif.UPLOAD_EXIF, DSL.name("upload_exif_upload_id"), new TableField[] { UploadExif.UPLOAD_EXIF.UPLOAD_ID }, Keys.UPLOADS_PKEY, new TableField[] { Uploads.UPLOADS.ID }, true);
    public static final ForeignKey<Record, Record> UPLOAD_PROGRESS_INFO__UPLOAD_PROGRESS_INFO_USER = Internal.createForeignKey(UploadProgressInfo.UPLOAD_PROGRESS_INFO, DSL.name("upload_progress_info_user"), new TableField[] { UploadProgressInfo.UPLOAD_PROGRESS_INFO.UPLOADER_USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
    public static final ForeignKey<Record, Record> UPLOAD_VIDEO_DATA__UPLOAD_VIDEO_DATA_UPLOAD_ID = Internal.createForeignKey(UploadVideoData.UPLOAD_VIDEO_DATA, DSL.name("upload_video_data_upload_id"), new TableField[] { UploadVideoData.UPLOAD_VIDEO_DATA.UPLOAD_ID }, Keys.UPLOADS_PKEY, new TableField[] { Uploads.UPLOADS.ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_EVENT_ID = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_event_id"), new TableField[] { Uploads.UPLOADS.EVENT_ID }, Keys.EVENT_PKEY, new TableField[] { Events.EVENTS.ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_MEDIA_ID = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_media_id"), new TableField[] { Uploads.UPLOADS.MEDIA_ID }, Keys.MEDIA_PKEY, new TableField[] { Media.MEDIA.MEDIA_ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_ORIGINAL_USER = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_original_user"), new TableField[] { Uploads.UPLOADS.ORIGINAL_UPLOADER_USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_PHOTOGRAPHER_USER = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_photographer_user"), new TableField[] { Uploads.UPLOADS.PHOTOGRAPHER_USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_RENDERED_MEDIA_ID = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_rendered_media_id"), new TableField[] { Uploads.UPLOADS.RENDERED_MEDIA_ID }, Keys.MEDIA_PKEY, new TableField[] { Media.MEDIA.MEDIA_ID }, true);
    public static final ForeignKey<Record, Record> UPLOADS__UPLOADS_THUMBNAIL_MEDIA_ID = Internal.createForeignKey(Uploads.UPLOADS, DSL.name("uploads_thumbnail_media_id"), new TableField[] { Uploads.UPLOADS.THUMBNAIL_MEDIA_ID }, Keys.MEDIA_PKEY, new TableField[] { Media.MEDIA.MEDIA_ID }, true);
