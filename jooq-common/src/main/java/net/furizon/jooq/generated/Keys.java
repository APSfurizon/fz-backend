...
public class Keys {
    ...
    public static final UniqueKey<Record> ORDERS_ONE_CHECKINSECRET_PER_EVENT = Internal.createUniqueKey(Orders.ORDERS, DSL.name("orders_one_checkinsecret_per_event"), new TableField[] { Orders.ORDERS.EVENT_ID, Orders.ORDERS.ORDER_CHECKIN_SECRET }, true);
    ...
    public static final UniqueKey<Record> ORDERS_ONE_ORDERCODE_PER_EVENT = Internal.createUniqueKey(Orders.ORDERS, DSL.name("orders_one_ordercode_per_event"), new TableField[] { Orders.ORDERS.EVENT_ID, Orders.ORDERS.ORDER_CODE }, true);
    public static final UniqueKey<Record> ORDERS_ONE_SECRET_PER_EVENT = Internal.createUniqueKey(Orders.ORDERS, DSL.name("orders_one_secret_per_event"), new TableField[] { Orders.ORDERS.EVENT_ID, Orders.ORDERS.ORDER_SECRET }, true);
